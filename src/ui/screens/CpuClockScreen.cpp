...
void CpuClockScreen::createWidgets() {
    ...
    widgetManager_.addWidget(std::unique_ptr<CpuClockWidget>(
        new CpuClockWidget(uiController_->getDisplayContext(),
                           WidgetInterface::Dimensions{0, 0, Layout::kScreenW, 272}, 250,
                           cpuClockData_)));
