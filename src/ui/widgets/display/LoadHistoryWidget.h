...
// sparkline. CPU load (Colors::kCpuAccent) is drawn as a filled bar; GPU load
// (Colors::kGpuAccent, same GPU accent color used elsewhere in the app) as a
// bright marker line on top of it, switching to the shared alert red (same
