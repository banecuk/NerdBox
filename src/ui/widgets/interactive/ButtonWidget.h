...
// Supported icon glyphs — backed by the 24px family generated by
// docs/generate_icons_24.py (see docs-local/03-visual-ux.md V17).
...
class ButtonWidget : public Widget {
 ...
 private:
    ...
    static constexpr uint8_t kIconSize = 24;  // icons_24.h pixel dimensions
